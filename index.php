						...
						<div class="row">
							<div class="col-md-3">
			                    <div class="team-player">
			                        <img src="./assets/img/sourav.jpg" alt="Thumbnail Image" class="img-raised img-circle">
			                ...
			                <div class="col-md-3">
			                    <div class="team-player">
			                        <img src="./assets/img/vivek15.jpg" alt="Thumbnail Image" class="img-raised img-circle">
							...
							<div class="col-md-3">
			                    <div class="team-player">
			                        <img src="./assets/img/amitesh.jpg" alt="Thumbnail Image" class="img-raised img-circle">
			                ...
			                <div class="col-md-3">
			                    <div class="team-player">
			                        <img src="./assets/img/harsh.jpg" alt="Thumbnail Image" class="img-raised img-circle">
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				<div class="card card-signup">
					...
					<p class="text-divider">Or Be Classical</p>
					<form class="form" action="home.php" method="post" onsubmit="return doit();">
						<div class="content">
							<div class="input-group ">
								<span class="input-group-addon">
